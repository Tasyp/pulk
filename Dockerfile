...
RUN apt-get update -y && apt-get install -y build-essential git npm \
    && apt-get clean && rm -f /var/lib/apt/lists/*_* && npm install --global yarn
...
COPY apps/pulk/mix.exs ./apps/pulk/mix.exs
COPY apps/pulk_web/mix.exs ./apps/pulk_web/mix.exs
...
# Prepare asset depds
RUN cd apps/pulk_web && mix assets.setup

# compile assets
RUN cd apps/pulk_web && mix assets.deploy
